...
<head>
	...
	<style>
		...
		.wsm-bg-indigo-600\/10 {
			background-color: rgba(var(--wsm-primary-rgb), 0.1) !important;
		}
		.wsm-bg-indigo-600\/20 {
			background-color: rgba(var(--wsm-primary-rgb), 0.2) !important;
		}
		.hover\:wsm-bg-indigo-500:hover {
			background-color: var(--wsm-primary) !important;
			filter: brightness(1.1) !important;
		}
		.hover\:wsm-bg-indigo-600:hover {
			background-color: var(--wsm-primary) !important;
		}
		.wsm-text-indigo-400 {
		...
		.wsm-bg-indigo-900\/30 {
			background-color: rgba(var(--wsm-primary-rgb), 0.3) !important;
		}
		.wsm-text-indigo-300 {
			color: var(--wsm-primary) !important;
		...
		/* Custom checkboxes hover & check colors */
		input[type="checkbox"]:hover {
			border-color: var(--wsm-primary) !important;
			box-shadow: 0 0 0 2px rgba(var(--wsm-primary-rgb), 0.2) !important;
		}
	...
	<div class="wsm-flex wsm-h-screen wsm-overflow-hidden wsm-bg-slate-950">
		...
		<aside id="wsm-sidebar" class="wsm-fixed wsm-inset-y-0 wsm-right-0 wsm-z-50 wsm-w-64 wsm-bg-slate-900 md:wsm-bg-slate-900/60 wsm-backdrop-blur-md wsm-border-l wsm-border-slate-800 wsm-flex wsm-flex-col wsm-transform wsm-translate-x-full md:wsm-translate-x-0 wsm-transition-transform wsm-duration-300 wsm-ease-in-out md:wsm-relative">
			...
			<nav class="wsm-flex-1 wsm-px-4 wsm-py-6 wsm-space-y-1 wsm-overflow-y-auto">
				...
				?>
				<?php if ( get_option( 'wsm_enable_dashboard', 'yes' ) === 'yes' && current_user_can( 'wsm_access_panel' ) ) : ?>
				...
				<?php if ( get_option( 'wsm_enable_orders', 'yes' ) === 'yes' && current_user_can( 'wsm_manage_orders' ) ) : ?>
				...
				<?php if ( get_option( 'wsm_enable_products', 'yes' ) === 'yes' && current_user_can( 'wsm_manage_products' ) ) : ?>
				...
				<?php if ( get_option( 'wsm_enable_categories', 'yes' ) === 'yes' && current_user_can( 'wsm_manage_products' ) ) : ?>
				...
				<?php if ( get_option( 'wsm_enable_attributes', 'yes' ) === 'yes' && current_user_can( 'wsm_manage_products' ) ) : ?>
				...
				<?php if ( get_option( 'wsm_enable_brands', 'yes' ) === 'yes' && current_user_can( 'wsm_manage_products' ) ) : ?>
				...
				<?php if ( get_option( 'wsm_enable_coupons', 'yes' ) === 'yes' && current_user_can( 'wsm_manage_coupons' ) ) : ?>
				...
				<?php if ( get_option( 'wsm_enable_reports', 'yes' ) === 'yes' && current_user_can( 'wsm_view_reports' ) ) : ?>
		...
		<div class="wsm-flex-1 wsm-flex wsm-flex-col wsm-overflow-hidden">
			...
			<header class="wsm-h-16 wsm-bg-slate-900/40 wsm-backdrop-blur-md wsm-border-b wsm-border-slate-800 wsm-flex wsm-items-center wsm-justify-between wsm-px-4 md:wsm-px-6">
				...
				<div class="wsm-flex wsm-items-center">
					...
					<span class="wsm-text-base md:wsm-text-lg wsm-font-bold wsm-bg-gradient-to-r wsm-from-indigo-400 wsm-to-cyan-400 wsm-bg-clip-text wsm-text-transparent"><?php echo esc_html( __( 'پنل مدیریت کاراسو', 'karasu-woo-pannel' ) ); ?></span>
				</div>
			...
			<main class="wsm-flex-1 wsm-overflow-y-auto wsm-p-6 wsm-bg-slate-950">
				...
				$custom_html = get_option( 'wsm_custom_html_' . $primary_view, '' );
				$custom_css  = get_option( 'wsm_custom_css_' . $primary_view, '' );
				$custom_js   = get_option( 'wsm_custom_js_' . $primary_view, '' );

				if ( ! empty( $custom_css ) ) {
					echo '<style>' . $custom_css . '</style>';
				}
				if ( ! empty( $custom_html ) ) {
					echo '<div class="wsm-custom-page-content wsm-mb-6 wsm-p-4 wsm-bg-slate-900/40 wsm-border wsm-border-slate-800/80 wsm-rounded-2xl">' . do_shortcode( $custom_html ) . '</div>';
				}
				if ( ! empty( $custom_js ) ) {
